...
Palabras = 'valoracion aprenderpython comida juego python web imposible variable curso volador cabeza reproductor mirada escritor billete lapicero celular valor revista gratuito disco voleibol anillo estrellaabecedario amor araña'.split()
...
def displayBoard(AHORCADO, letraIncorrecta, letraCorrecta, palabraSecreta):
        ...
        for i in range(len(palabraSecreta)): # Aqui se reemplaza los espacios en blanco
...
def elijeLetra(algunaLetra):
    # En esta parte se devuelve la letra que el jugador ingresó. Esta funcion hace que el jugador ingrese una letra y no cualquier otra cosa
    while True:
        ...
        if len(letra) !=1:
            ...
            print('Ya nombraste esa letra, ¿por que no pruebas con otra?')
